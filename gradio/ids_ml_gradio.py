...
grShow = gr.Interface(
    ...
    description="Cyber Attack - Intrusion Detection Prediction using Machine Learning Models (XG Boost) <br> Designed & Developed by Raghava <br> GitHub: @raghavavidyapriya <br> Date Created: June 10, 2023 | Last Updated: May 13, 2024 <br> Examples are at the bottom of this page.",
